...
// Importa a instância de VendaItemController, assumindo que ele exporta a classe
import VendaItemController from '../controllers/VendaItemController';

const router = Router();

// 🔑 CORREÇÃO TS2613: Instanciar a classe VendaComandaController
const VendaController = new VendaComandaController();
