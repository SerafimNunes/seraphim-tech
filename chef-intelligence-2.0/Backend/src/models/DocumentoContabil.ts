...
export default class DocumentoContabil
    extends Model<DocumentoContabilAttributes, DocumentoContabilCreationAttributes>
...
DocumentoContabil.init(
    {
        ...
        conta_contabil_id: {
            type: DataTypes.INTEGER,
            allowNull: false,
            references: { model: 'CONTAS_CONTABEIS', key: 'id_conta_contabil' },
        },
        tipo_lancamento: {
    ...
    },
    {
        ...
        tableName: 'DOCUMENTOS_CONTABEIS',
        underscored: true,
    },
);
